<x-layout title="QuickCart" full>
    <div class="min-h-screen w-screen overflow-y-auto flex flex-col gap-4">
        <section
            ...
            <x-menuButton href="/menu">Explore Our Menu</x-menuButton>
        ...
        <section class="bg-[#F6B75C] py-12 px-6 lg:px-20 flex flex-col lg:flex-row items-center lg:items-start gap-10">
            <!-- Left Content -->
